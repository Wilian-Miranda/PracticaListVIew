...
class MainActivity : AppCompatActivity() {
    ...
    fun calcular(vista:View){
        ...
        /*println("Valor del dato 1: ${num1}");
        println("Valor del dato 2: ${num2}");*/
    ...
    fun showLanguajeActivity(vista:View){
        val lenguajeActivity = Intent(applicationContext, ListViewPractice::class.java);
        startActivity(lenguajeActivity);
